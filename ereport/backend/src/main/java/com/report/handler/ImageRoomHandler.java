...
public class ImageRoomHandler {
    ...
    public Mono<ServerResponse> get(ServerRequest r) {
        return defaultReadResponse(imageRoomService.get(new ImageRoomKey(room_number(r), year_month(r))));
    }
    ...
    public Mono<ServerResponse> create(ServerRequest r) {
        ...
        return r.body(BodyExtractors.toMultipartData()).flatMap(parts ->
        {
            ...
            Flux<DataBuffer> content = map.get("file").content();
            ...
            return Flux.zip(room_number, year_month, content).flatMap(t ->
                    {
                        ...
                        try {
                            ...
                            return created(URI.create(String.format("/image/room?room_number=%s&year_month=%s", room_number_url, year_month_url, "UTF8"))).
    ...
    private static String room_number(ServerRequest r) {
        return r.pathVariable("room_number");
    }
